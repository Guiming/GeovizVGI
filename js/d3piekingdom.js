...
var color_kingdom = d3.scale.ordinal()
                    .domain(["Plantae", "Actinopterygii", "Mammalia", "Insecta", "Amphibia", "Mollusca", "Aves", "Animalia", "Arachnida", "Fungi", "Reptilia","Chromista", "Protozoa"])
                    .range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00","#66c2a5","#fc8d62","#8da0cb","#e78ac3","#a6d854", "#7dc825"]);
// more color scales: https://bl.ocks.org/pstuffa/3393ff2711a53975040077b7453781a9

var svg_pie_kingdom;

function draw_piechart_kingdom(dataset, update){

  if(/*true == update*/d3.select("#svg_species_kingdom")[0][0] != null){
    d3.select("#svg_species_kingdom").remove();
  }
  ...
  svg_pie_kingdom = d3.select('#d3piekingdom') // select element in the DOM with id 'chart'
    .append('svg') // append an svg element to the element we've selected
    .attr("id", "svg_species_kingdom")
  ...
  // define tooltip
  var tooltip = d3.select('#d3piekingdom') // select element in the DOM with id 'chart'
